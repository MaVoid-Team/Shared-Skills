---
name: distill
description: Strip designs to their essence by removing unnecessary complexity. Great design is simple, powerful, and clean. Use for: (add when to use this skill in your project).
user-invokable: true
