---
name: quieter
description: Tone down overly bold or visually aggressive designs. Reduces intensity while maintaining design quality and impact. Use for: (add when to use this skill in your project).
user-invokable: true
