---
name: bolder
description: Amplify safe or boring designs to make them more visually interesting and stimulating. Increases impact while maintaining usability. Use for: (add when to use this skill in your project).
user-invokable: true
