...
description: Multi-agent coordination patterns for OpenCode swarm workflows. Use for: parallelizable work, multi-agent task decomposition, and cross-file coordination.
---
