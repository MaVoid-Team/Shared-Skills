...
### Validation
At any point, review traceability consistency across CP → CN → FR.
...
**IMPORTANT:** Traceability validation is **MANDATORY** after Steps 3 and 5 to verify coverage and identify gaps.
...
- [ ] **MANDATORY: Validate traceability** (CP → CN mapping)
...
- [ ] **MANDATORY: Validate full traceability chain** (FR → CN → CP)
...
Check existing artifacts for traceability without generating new ones.
...
- **Validation:** Review traceability after each sprint to ensure consistency
